...
const BonusContent = {
    chapters: {
        ...
        6: { title_de: 'Für Fortgeschrittene: Echte ETF-Auswahl', title_en: 'Advanced: Real ETF Selection', title_fr: 'Avancé : Sélection réelle d\'ETF',
             content_de: '<p>Die beliebtesten ETFs für Anfänger in Deutschland:</p><ul><li><strong>MSCI World</strong> — ca. 1.500 Unternehmen aus 23 Industrieländern. Der "Klassiker".</li><li><strong>MSCI All Country World (ACWI)</strong> — wie MSCI World, aber mit Schwellenländern (~3.000 Unternehmen).</li><li><strong>FTSE All-World</strong> — Alternative zum ACWI von Vanguard.</li></ul><p class="mt-2">Wichtige Kennzahlen: <strong>TER</strong> (Total Expense Ratio, jährliche Kosten, je niedriger desto besser, typisch 0,1-0,3%), <strong>Fondsgröße</strong> (>100 Mio. € ist gut), <strong>Replikation</strong> (physisch ist transparent, synthetisch kann günstiger sein).</p><div class="warning-box mt-4"><p><strong>⚠️ Die wahren Kosten: TER + Steuern</strong></p><p class="mt-1">Die TER ist nicht alles! Bei 7% Brutto-Rendite sehen die echten Kosten so aus:</p><ul><li><strong>TER:</strong> ~0,2% pro Jahr (z.B. bei einem MSCI World ETF)</li><li><strong>Steuern:</strong> Abgeltungssteuer 26,375%, aber dank <strong>Teilfreistellung (30%)</strong> bei Aktien-ETFs effektiv nur ~18,46% auf Gewinne</li><li><strong>Sparerpauschbetrag:</strong> 1.000 € Gewinne pro Jahr steuerfrei</li><li><strong>Vorabpauschale:</strong> Bei thesaurierenden ETFs fällt jährlich eine kleine Steuer auf Basiszins × 0,7 × Fondswert an</li></ul><p class="mt-1">Beispiel: Bei 10.000 € Gewinn nach Teilfreistellung → 7.000 € steuerpflichtig, minus 1.000 € Pauschbetrag = 6.000 € × 26,375% = <strong>1.583 € Steuer</strong>. Von 10.000 € Gewinn bleiben dir 8.417 € netto!</p></div>',
             content_en: '<p>The most popular starter ETFs:</p><ul><li><strong>MSCI World</strong> — ~1,500 companies from 23 developed countries. The "classic".</li><li><strong>MSCI All Country World (ACWI)</strong> — like MSCI World, but including emerging markets (~3,000 companies).</li><li><strong>FTSE All-World</strong> — Vanguard\'s alternative to ACWI.</li></ul><p class="mt-2">Key metrics: <strong>TER</strong> (Total Expense Ratio, annual costs, lower is better, typically 0.1-0.3%), <strong>Fund size</strong> (>100M € is good), <strong>Replication</strong> (physical is transparent, synthetic can be cheaper).</p><div class="warning-box mt-4"><p><strong>⚠️ The real costs: TER + Taxes</strong></p><p class="mt-1">TER isn\'t everything! With a 7% gross return, the real costs look like this:</p><ul><li><strong>TER:</strong> ~0.2% per year (e.g. for an MSCI World ETF)</li><li><strong>Taxes:</strong> Flat tax (Abgeltungssteuer) 26.375%, but thanks to <strong>partial exemption (30%)</strong> for equity ETFs, effectively only ~18.46% on gains</li><li><strong>Saver\'s allowance:</strong> €1,000 in gains per year tax-free</li><li><strong>Advance lump sum (Vorabpauschale):</strong> For accumulating ETFs, a small annual tax on base rate × 0.7 × fund value</li></ul><p class="mt-1">Example: With €10,000 gain after partial exemption → €7,000 taxable, minus €1,000 allowance = €6,000 × 26.375% = <strong>€1,583 tax</strong>. From €10,000 gain you keep €8,417 net!</p></div>',
             content_fr: '<p>Les ETF les plus populaires pour débuter :</p><ul><li><strong>MSCI World</strong> — ~1 500 entreprises de 23 pays développés. Le "classique".</li><li><strong>MSCI ACWI</strong> — comme le MSCI World, mais avec les marchés émergents (~3 000 entreprises).</li><li><strong>FTSE All-World</strong> — alternative de Vanguard.</li></ul><p class="mt-2">Indicateurs clés : <strong>TER</strong> (coûts annuels, plus bas = mieux, typiquement 0,1-0,3%), <strong>Taille du fonds</strong> (>100M € c\'est bien), <strong>Réplication</strong> (physique = transparente, synthétique = parfois moins chère).</p><div class="warning-box mt-4"><p><strong>⚠️ Les vrais coûts : TER + Impôts</strong></p><p class="mt-1">Le TER ne fait pas tout ! Avec un rendement brut de 7 %, les vrais coûts ressemblent à ceci :</p><ul><li><strong>TER :</strong> ~0,2 % par an (ex. pour un ETF MSCI World)</li><li><strong>Impôts :</strong> Abgeltungssteuer 26,375 %, mais grâce à l\'<strong>exonération partielle (30 %)</strong> pour les ETFs actions, effectivement seulement ~18,46 % sur les gains</li><li><strong>Abattement :</strong> 1 000 € de gains par an exonérés d\'impôts</li><li><strong>Forfait anticipé (Vorabpauschale) :</strong> Pour les ETFs capitalisants, un petit impôt annuel sur taux de base × 0,7 × valeur du fonds</li></ul><p class="mt-1">Exemple : Avec 10 000 € de gain après exonération partielle → 7 000 € imposables, moins 1 000 € d\'abattement = 6 000 € × 26,375 % = <strong>1 583 € d\'impôt</strong>. Sur 10 000 € de gain, il te reste 8 417 € net !</p></div>' },
